...
#define __GMP_CFLAGS "-arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/AppleTVSimulator.platform/Developer/SDKs/AppleTVSimulator26.2.sdk -target arm64-apple-tvos13.0-simulator -mtvos-simulator-version-min=13.0 -fno-common"
