...
//            type: .static,
        ...
        .library(name: "nettle", targets: ["gmp", "nettle"]),
        .library(name: "hogweed", targets: ["gmp", "nettle", "hogweed"]),
        .library(name: "gnutls", targets: ["gmp", "nettle", "hogweed", "gnutls"]),
        ...
        .library(name: "lcms2", targets: ["lcms2"]),
        .library(name: "libbluray", targets: ["libbluray"]),
        .library(name: "libcrypto", targets: ["libcrypto"]),
        .library(name: "libssl", targets: ["libssl"]),
        .library(name: "libtls", targets: ["libtls"]),
        .library(name: "libdav1d", targets: ["libdav1d"]),
        .library(name: "libdovi", targets: ["libdovi"]),
        .library(name: "libfontconfig", targets: ["libfontconfig"]),
        ...
        .library(name: "libshaderc_combined", targets: ["libshaderc_combined"]),
        .library(name: "libsmbclient", targets: ["libsmbclient"]),
